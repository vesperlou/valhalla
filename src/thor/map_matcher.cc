...
std::vector<std::vector<std::pair<PathInfo, const meili::EdgeSegment*>>>
MapMatcher::FormPath(meili::MapMatcher* matcher,
  ...
  std::vector<std::vector<std::pair<PathInfo, const meili::EdgeSegment*>>> pathes;
  pathes.reserve(edge_segments.size());
  pathes.emplace_back();
  ...
  auto num_segments = edge_segments.size();
...
std::vector<std::vector<std::pair<PathInfo, const meili::EdgeSegment*>>>
MapMatcher::FormPath_new(meili::MapMatcher* matcher,
                         const std::vector<meili::MatchResult>& results,
                         const std::vector<meili::EdgeSegment>& edge_segments,
                         const std::shared_ptr<sif::DynamicCost>* mode_costing,
                         const sif::TravelMode mode,
