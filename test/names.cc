...
TEST(Names, NamesTest) {
  ...
  w1.GetNames(ref, name_offset_map, pronunciation, default_languages, w1.name_index(), 0,
              w1.official_name_index(), 0, w1.alt_name_index(), 0, types, w1_names, pronunciations);
  ...
  w2.GetNames("", name_offset_map, pronunciation, default_languages, w2.name_index(), 0,
              w2.official_name_index(), 0, w2.alt_name_index(), 0, types, w2_names, pronunciations);
  ...
  pronunciations.clear();
  w3.GetNames("", name_offset_map, pronunciation, default_languages, w3.name_index(), 0,
              w3.official_name_index(), 0, w3.alt_name_index(), 0, types, w3_names, pronunciations);
  ...
  w3_names.clear();
  pronunciations.clear();
  w3.GetNames("PA 555", name_offset_map, pronunciation, default_languages, w3.name_index(), 0,
              w3.official_name_index(), 0, w3.alt_name_index(), 0, types, w3_names, pronunciations);
  ...
  // TestKeyTypeValue(pronunciations.at(17), 4, PronunciationAlphabet::kNtSampa, "test name en
